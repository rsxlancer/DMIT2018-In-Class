...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
   <%-- //Original menu repeater that showed Item entities
        ...
        <ItemTemplate>
            ...
            &mdash; <%# Eval("Description") %> &mdash; <%# Eval("MenuCategory.Description") %>
    ...
    <div class="row col-md-12">
     ...
     <asp:Repeater ID="MenuItemRepeater" runat="server" DataSourceID="MenuItemDataSource">
        <ItemTemplate>
           ...
           <h3>
               <img src='<%# "Images/" + Eval("Description") + "-1.png" %>' alt="" /> <%# Eval("Description") %>
           </h3>
            <div class="well">
            <asp:Repeater ID="ItemDetailRepeater" runat="server" DataSource='<%# Eval("MenuItems") %>'> 
                <%--use single quotes when using Evals--%>
                <ItemTemplate>
                    <div>
                        <h4>
                        <%# Eval("Description") %>  
