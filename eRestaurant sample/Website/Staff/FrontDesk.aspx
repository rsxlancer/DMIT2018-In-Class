    ...
    <div class="row col-md-12">
        ...
        <div class="col-md-7">
            <details open>
                ...
                <asp:GridView ID="SeatingGridView" runat="server" CssClass="table table-hover table-striped table-condensed"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <%--Display either the occupied table or a form to seat walk -in customers--%>
                                <asp:Panel ID="WalkInSeatingPanel" runat="server" CssClass="input-group input-group-sm" Visible="<%# ! Item.Taken %>">
                                    ...
                                    <asp:LinkButton ID="LinkButton1" runat="server" Text="Seat Customers" CssClass="input-group-btn" CommandName="Select" CausesValidation="false" />
                                </asp:Panel>

                                <asp:Panel ID="OccupiedSeatingPanel" runat="server" Visible="<%# Item.Taken %>">
                                    <%--waiter - ReservationName - $$$$--%>
                                    <%# Item.Waiter %>
                                    <asp:Label ID="ReservationNameLabel" runat="server" Text='<%# "&mdash; " + Item.ReservationName %>' Visible='<%# !string.IsNullOrEmpty(Item.ReservationName) %>' />
                                    --TODO: Bill$
                                </asp:Panel>
                            </ItemTemplate>
                        </asp:TemplateField>
